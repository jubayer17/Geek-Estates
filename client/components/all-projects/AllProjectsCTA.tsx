...
export default function AllProjectsCTA() {
  return (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-serif text-white mb-8 leading-tight">
              Can&apos;t find exactly what <br className="hidden md:block" />
              <span className="italic text-[#E7C873]">you&apos;re looking for?</span>
            </h2>
            <p className="text-white/60 text-lg md:text-xl font-light mb-12 max-w-2xl mx-auto leading-relaxed">
              Our private collection includes exclusive off-market listings reserved for our most discerning clients. Let us help you find your perfect match.
            </p>
