  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-center mb-2">
        ...
        <span className="text-3xl md:text-4xl font-serif text-[#E7C873] ml-1">
          {stat.suffix}
        </span>
      </div>
      <p className="text-[#E7C873] text-xs font-bold uppercase tracking-[0.2em] mb-3">{stat.label}</p>
      <p className="text-sm text-gray-500 font-light leading-relaxed max-w-[200px] mx-auto">{stat.description}</p>
    </motion.div>
  )
}
